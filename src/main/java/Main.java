...
//        tool simulating N games for M players
        dealService.simulateNGamesForMPlayers(10,8);
...
//        dealService.simulateTillOnePlayerHas_XSequence_AndSecondHas_YSequence(PokerSequenceType.FLUSH,PokerSequenceType.STRAIGHT);
